        ...
        <div class="page-head">
            <div class="min-w-0">
                <div class="page-head__title">
                    ...
                    <span v-if="data.label" class="pill pill--accent">{{
                        data.label
                    }}</span>
                </div>
        ...
        <div class="stat-strip mb-4">
            <div class="stat-cell">
                ...
                <div class="stat-cell__value">
                    {{ fmtEth(data.balance_eth) }}
                </div>
                <div class="stat-cell__meta">
                    {{ fmtUsd(data.balance_eth * eth_price) }}
                </div>
            </div>
            <div class="stat-cell">
            ...
            <div class="stat-cell">
                ...
                <div class="stat-cell__value text-base">
                    {{ data.first_seen_age }}
                </div>
                <div class="stat-cell__meta">
                    {{ isoTime(data.first_seen) }}
                </div>
            </div>
            <div class="stat-cell">
                <div class="stat-cell__label">Type</div>
                <div class="stat-cell__value">
                    {{ data.is_contract ? 'Contract' : 'EOA' }}
                </div>
                <div class="stat-cell__meta">
                    {{
                        data.is_contract ? 'Smart contract' : 'Externally owned'
                    }}
                </div>
            </div>
        </div>
                ...
                >
                    ...
                    <div class="field">
                        ...
                        <div class="field__sub">
                            ...
                            <span
                                class="ml-1 text-[color:var(--color-fg-dim)]"
                                >{{ t.age }}</span
                            >
                        </div>
                    </div>
                    <div class="field">
                        ...
                        <div class="field__value field__value--mono text-xs">
                            <Hash
                                :value="t.direction === 'in' ? t.from : t.to"
                                truncate="address"
                            />
                        </div>
                    </div>
